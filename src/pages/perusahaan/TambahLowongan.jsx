    ...
    const { error } = await supabase.from("lowongan").insert([
      {
        ...
        status: "aktif", // Default status saat dibuat
      },
    ]);
    ...
    <PerusahaanLayout>
      ...
      <div>
        ...
        <p className="mt-1 text-gray-600">
          Isi detail di bawah ini untuk mempublikasikan peluang magang baru.
        </p>
      </div>
              ...
              <div className="md:col-span-2">
                <FormField label="Deskripsi Singkat">
                  <textarea
                    ...
                    required
                    className="w-full p-2 border border-gray-300 rounded-lg"
                    placeholder="Jelaskan secara singkat tentang posisi ini"
                  />
                </FormField>
              </div>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField label="Latar Belakang Pendidikan">
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-lg"
                  placeholder="Jurusan yang relevan, semester, dll."
                />
              </FormField>
              <FormField label="Kompetensi Teknis">
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-lg"
                  placeholder="Contoh: React, Node.js, Figma"
                />
              </FormField>
              <FormField label="Soft Skill">
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-lg"
                  placeholder="Contoh: Komunikasi, Kerja Tim"
                />
              </FormField>
              <FormField label="Persyaratan Khusus">
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-lg"
                  placeholder="Jika ada, misal: bersedia WFO"
                />
              </FormField>
            </div>
          </div>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField label="Rincian Penugasan">
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-lg"
                  placeholder="Jelaskan tugas sehari-hari"
                />
              </FormField>
